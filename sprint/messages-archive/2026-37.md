# Messages, week 37 (2026-09-09 → 2026-09-13)

Archived by the Retrospective on 2026-09-13. These entries were read and acted on; the round table for the week is
`sprint/retro/2026-37.md`. Threads that were still open on 2026-09-13 stayed on `sprint/messages.md` rather than moving here.
